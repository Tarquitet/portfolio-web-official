/* ==========================================
   ARCHIVO DE DATOS (data.js) - VERSIÓN 2.0
   ========================================== */

// 1. PROYECTOS (SOLO DESARROLLO, DISEÑO & JUEGOS)
// Los videos puros se movieron a 'manualVideos'
const projectsData = [
  /* --- GRUPO 1: PROYECTOS DE IA & LÓGICA --- */
  {
    title: 'Sudoku<br>Intelligent Solver',
    type: 'Proyecto Universitario',
    badgeIcon: 'cpu',
    desc: 'Proyecto de IA que genera y resuelve Sudokus mediante Backtracking eficiente.',
    tags: ['C#', 'Backtracking', 'IA'],
    image:
  ...
  /* --- GRUPO 2: WEB, APPS & SIMULACIÓN --- */
  {
    title: 'CarVoice<br>Assistant',
    type: 'Proyecto Universitario',
    badgeIcon: 'mic',
    desc: 'Asistente virtual para vehículos con control por voz e integración web.',
    tags: ['Voiceflow', 'JavaScript', 'Chatbot'],
    image:
  ...
  {
    title: 'Builtechraft<br>Web Portal',
    type: 'Proyecto Personal',
    badgeIcon: 'box',
    desc: 'Portal Web inspirado en las mecánicas de crafteo de Minecraft.',
    tags: ['HTML/CSS', 'Frontend', 'Gaming UI'],
    image: './assets/images/Builtechraft-web-2024.webp',
    link: 'https://tarquitet.github.io/Builtechraft-Web/',
  },
  {
    title: 'Experiencia<br>360° VR',
    type: 'Proyecto Universitario',
    badgeIcon: 'glasses',
    desc: 'Experiencia de terror en Realidad Virtual renderizada en Unity.',
    tags: ['Unity', 'VR', 'Audio 3D'],
    image: './assets/images/audio-video-360.webp',
    link: 'https://www.youtube.com/watch?v=Z8sgOhYMAl4',
  },
  {
    title: 'Simulación<br>OpenGL 3D',
    type: 'Proyecto Universitario',
    badgeIcon: 'box',
    desc: 'Minijuego de recolección simulado con físicas básicas.',
    tags: ['Unity', 'OpenGL', 'C++', 'Simulación'],
    image: './assets/images/unity-opengl-web.webp',
    link: 'https://relaxed-valkyrie-75101a.netlify.app/',
  },
  {
    title: 'Página Web<br>Ministerial',
    type: 'Proyecto Profesional',
    badgeIcon: 'briefcase',
    desc: 'Landing Page oficial para el ministerio Verdad & Fe.',
    tags: ['Web Design', 'Frontend', 'Producción'],
    image: '../assets/images/verdadyfe.webp',
    link: 'https://www.verdadyfe.org/',
  },

  /* --- GRUPO 3: DISEÑO UX/UI --- */
  {
    title: 'New Sporify:<br>Sonórus',
    type: 'Proyecto Universitario',
    badgeIcon: 'palette',
    desc: 'Diseño de interfaz alternativa (Redesign) para Spotify.',
    tags: ['Figma', 'UI Design', 'Prototyping'],
    image: '../assets/images/Sonorus-Figma.webp',
    link: 'https://www.figma.com/design/lClUfMJDAuqfEhvXN6IN2B/Untitled?node-id=0-1&t=UD8TxB4UupRydWWD-1',
  },
  {
    title: '4 Better Pets<br>App',
    type: 'Proyecto Universitario',
    badgeIcon: 'palette',
    desc: 'App móvil para facilitar la adopción de mascotas.',
    tags: ['Figma', 'UX Research', 'Mobile Design'],
    image: '../assets/images/4better-pets-app.webp',
    link: 'https://www.figma.com/design/8LDG3cejNOO7Re9Z6MMrfU/4-BETTER-PETS?node-id=0-1&t=fkQtYiNLOuIEM5Uo-1',
  },
  {
    title: 'Rappi UI<br>Redesign',
    type: 'Proyecto Universitario',
    badgeIcon: 'palette',
    desc: 'Propuesta de rediseño para mejorar la UX de Rappi.',
    tags: ['Figma', 'UI Kit', 'Redesign'],
    image: '../assets/images/RediseñoRappi-Figma.webp',
    link: 'https://www.figma.com/design/W8tY2RtS3hM7B9BQjJgpiB/David-Pinto---Redise%C3%B1o-Rappi?node-id=0-1&t=UmSvMcQEsiyU7y4s-1',
  },
  {
    title: 'In-Mortal<br>Transmedia',
    type: 'Proyecto Personal',
    badgeIcon: 'feather',
    desc: 'Exploración narrativa transmedia sobre la evolución de las ideas.',
    tags: ['Storytelling', 'Wix', 'Concept Art'],
    image:
      'https://static.wixstatic.com/media/5d4a70_7d7ad22b0b4f4defbc347b359909bcb1~mv2.jpg/v1/fill/w_1930,h_1229,al_c,q_90,enc_avif,quality_auto/5d4a70_7d7ad22b0b4f4defbc347b359909bcb1~mv2.jpg',
    link: 'https://pintodavid2002.wixsite.com/in-mortal',
  },
];

// 2. VIDEOS MANUALES (ARCHIVO, OCULTOS, OTROS CANALES)
// Estos se mezclarán automáticamente con los videos de "Tarquiet!"
const manualVideos = [
  /* --- CORTOS DE ANIMACIÓN (Playblasts) --- */
  {
  ...
  {
    title: 'Playblast & Edit Cops & Robbers 3D',
    id: 'V3ABRvOuce0',
    date: '2023-08-15',
    channel: 'ARCHIVO',
  ...
  /* --- EDICIÓN DE VIDEO (Freelance / Universitario) --- */
  {
...
// 3. GALERÍA VISUAL (ILUSTRACIONES)
const galleryData = [
  {
    title: 'Alika Christmas Pose',
    desc: 'Reto de ilustración combinando referencias festivas.',
    date: '2024-01-05',
    image: '../assets/images/ilustraciones/2024_Alika_pose_Watermark_Muestra_JPG.jpg',
  },
  {
    title: 'Akiko Princess Pose',
    desc: 'Ilustración de personaje estilo princesa.',
    date: '2024-10-14',
    image: '../assets/images/ilustraciones/2024_Akiko_princess_pose_Watermark_Muestra_JPG.jpg',
  },
  {
    title: 'Atila Wolf Risa',
    desc: 'Expresión facial de personaje original (Furry Art).',
    date: '2025-01-12',
    image: '../assets/images/ilustraciones/atila-risa-watermark.jpg',
  },
  {
    title: 'Atila Wolf Frente',
    desc: 'Vista frontal de personaje (Character Design).',
    date: '2025-01-12',
    image: '../assets/images/ilustraciones/atila-frente-watermark.jpg',
  },
  {
    title: 'Atila Wolf 3/4',
    desc: 'Estudio de perspectiva 3/4 para personaje.',
    date: '2025-01-12',
    image: '../assets/images/ilustraciones/atila-3-4-watermark.jpg',
  },
];

// 4. HABILIDADES (USADO SOLO PARA EL TICKER DE FONDO)
const skillsData = [
  { name: 'Figma' },
  { name: 'Unity 3D' },
  { name: 'Photoshop' },
...
const trajectoryData = [
  {
    ...
    desc: 'Fusión de matemáticas, diseño y programación.',
    type: 'education',
  },
  {
    date: '2006 - 2019',
    title: 'Bachiller Académico',
    place: 'Colegio Santa Ana Fontibón',
    desc: 'Énfasis universitario en sistemas.',
    type: 'education',
  },
];
