import { CONFIG } from './modules/config.min.js';
import { UI } from './modules/ui.min.js';
import { Renderer } from './modules/renderer.min.js';
  ...
  init() {
    try {
      ...
      window.addEventListener('resize', () => {
        ...
        resizeTimer = setTimeout(() => this.renderer.renderAll(), 200);
      });
