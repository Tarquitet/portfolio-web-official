...
window.mainPortfolio = [
  ...
  },
  {
    ...
    fileName: 'IBHOREB-1',
    link: 'pendiente link web instituto',
  ...
  {
    title: 'Front Announcement - IUJ Church',
    fileName: 'IUJ LA GLORIA - Anuncio frontal',
    link: 'https://www.youtube.com/@IUJLaGloria',
  ...
  },
  {
    ...
    fileName: 'test_2',
    link: 'imagen fullscreen',
    desc: 'Second design inspired by Retro CGI from before the 2000\'s',
    tools: [T.MAYA, T.PHOTO],
    category: CAT.DES,
    context: CTX.PERS,
  },
  {
    ...
    fileName: 'test_3',
    link: 'imagen fullscreen',
    desc: 'First design inspired by Retro CGI from before the 2000\'s',
    tools: [T.MAYA, T.PHOTO],
    category: CAT.DES,
    context: CTX.PERS,
  },
